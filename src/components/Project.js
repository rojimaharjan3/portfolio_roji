...
const Project = ({ title, description, image, link }) => {
  return (
    ...
    <div className='w-full h-full flex flex-col border shadow-lg duration-500 hover:-translate-y-3 hover:duration-700 hover:ease-linear' >
      ...
      <div className='w-full h-48 flex justify-center'> {/* Set the height of the image container */}
        <img src={image} alt={title} className="w-full h-full object-contain" /> {/* Apply object-cover to make sure the image fills the container */}
      </div>
